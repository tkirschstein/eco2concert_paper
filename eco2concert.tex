...
\hypersetup{breaklinks=true,
            bookmarks=true,
            pdfauthor={},
            pdftitle={Configurating temporal energy supply systems - A case study from green field festival organisation},
            colorlinks=false,
            urlcolor=blue,
            linkcolor=magenta,
            pdfborder={0 0 0}}
...
\begin{frontmatter}
  ...
  \title{Configurating temporal energy supply systems - A case study
from green field festival organisation}
    \author[Fraunhofer IKTS - CEM]{Thomas Kirschstein%
  \corref{cor1}%
  \fnref{1}}
   \ead{thomas.kirschstein@ikts.fraunhofer.de} 
    \author[Fraunhofer IKTS - CEM]{Lisa Plümer%
  %
  }
   \ead{lisa.pluemer@ikts.fraunhofer.de} 
      \affiliation[Fraunhofer IKTS - CEM]{
    organization={Fraunhofer IKTS - CEM},addressline={Leipziger Strasse
70/71},city={Halle},postcode={6108},country={Germany},}
    \cortext[cor1]{Corresponding author}
    \fntext[1]{Second affiliation: RhineMain University of Applied
Sciences, Wiesbaden}
...
{\centering \includegraphics[width=0.5\linewidth]{eco2concert_files/figure-latex/fig2-1} 
